...
function AboutMe({ onClick }: { onClick?: () => void }) {
...
function Projects({ onClick }: { onClick?: () => void }) {
...
function Resume({ onClick }: { onClick?: () => void }) {
...
function useActiveLinkStyle(path: string) {
