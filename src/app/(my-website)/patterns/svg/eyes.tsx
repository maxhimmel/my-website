  ...
  return isBackground ? (
    <div className="size-full relative">
      <div className="size-full absolute">
        <EyesPattern className={`size-full ${className}`} />
      </div>
