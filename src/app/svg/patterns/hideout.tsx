...
export function HideoutPattern({
  className,
  isBackground,
  children,
  animations,
  ...
  return isBackground ? (
    <div className="size-full relative">
      <div className="size-full absolute">
        <HideoutPattern className={`size-full ${className}`} />
      </div>
